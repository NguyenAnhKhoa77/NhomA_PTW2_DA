                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-orders" role="tabpanel">
                                    ...
                                    <ul class="nav nav-tabs nav-justified mb-3">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{ route('orders.pending') }}">Pending</a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card card-stepper mt-1 mb-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <p class="text-muted">Tracking Status:
                                                                        <span
                                                                            class="text-body">{{ $orderPending->status }}</span>
                                                                    </p>
                                                                    <h4 class="mt-3 mb-3">
                                                                        Total: {{ number_format($orderPending->total) }}
                                                                        VNĐ<span
                                                                            class="small text-muted"> via @if($orderPending->payment_type == 0)
                                                                                Cash On Delivery
                                                                            @else
                                                                ...
                                                                <div>
                                                                    <form
                                                                        action="{{ route('orders.detail', $orderPending->id) }}"
                                                                        method="get">
                                                                        <button type="submit"
                                                        ...
                                                        <div class="card-body border p-4">
                                                            @php
                                                                $orders = \App\Models\Orders::where('bill_id', $orderPending->id)->get();
                                                            @endphp
                                                        ...
                                                        <div class="card-footer p-4">
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <form
                                                                    action="{{ route('orders.cancel.status', $orderPending->id) }}"
                                                                    method="post">
                                                                    @csrf
