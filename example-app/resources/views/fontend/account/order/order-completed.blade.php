                                    ...
                                    <ul class="nav nav-tabs nav-justified mb-3">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active"
                                               href="{{ route('orders.completed') }}">Completed</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('orders.cancelled') }}">Cancelled</a>
                                        </li>
                                    </ul>
                                    <!-- Tabs navs -->
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card card-stepper mt-1 mb-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    <p class="text-muted">Tracking Status:
                                                                        <span
                                                                            class="text-body">{{ $orderCompleted->status }}</span>
                                                                    </p>
                                                                    <h4 class="mt-3 mb-3">
                                                                        Total: {{ number_format($orderCompleted->total) }}
                                                                        VNĐ<span
                                                                            class="small text-muted"> via @if($orderCompleted->payment_type == 0)
                                                                                Cash On Delivery
                                                                            @else
                                                                ...
                                                                <div>
                                                                    <form
                                                                        action="{{ route('orders.detail', $orderCompleted->id) }}"
                                                                        method="get">
                                                                        <button type="submit"
                                                        ...
                                                        <div class="card-body border p-4">
                                                            @php
                                                                $orders = \App\Models\Orders::where('bill_id', $orderCompleted->id)->get();
                                                            @endphp
                                                        ...
                                                        <div class="card-footer p-4">
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <form action="{{ route('orders.pre-pay.status', $orderCompleted->id) }}" method="post">
                                                                    @csrf
